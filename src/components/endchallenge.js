...
export class EndChallenge extends Phaser.GameObjects.Container {
    ...
    constructor(scene) {
        ...
        this.add(this.text1);
        this.text2 = new Phaser.GameObjects.Text(scene, 0, 40, "", { color: '#ffffff', align: 'left', fontSize: 14, wordWrap: { width: 240, useAdvancedWrap: true } });
        this.add(this.text2);
        this.text3 = new Phaser.GameObjects.Text(scene, 0, 65, "", { color: '#ffffff', align: 'left', fontSize: 14, wordWrap: { width: 240, useAdvancedWrap: true } });
        this.add(this.text3);
        ...
        this.text6 = new Phaser.GameObjects.Text(scene, 0, 160, "", { color: '#ffffff', align: 'left', fontSize: 18, wordWrap: { width: 240, useAdvancedWrap: true } });
        this.add(this.text6);
