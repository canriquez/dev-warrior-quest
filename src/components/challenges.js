  ...
  const challenges = [
    {
      ...
      winFactor: 0.8, // Affects deamons damage on hero 0-1. 0 easy
      extraPower: 1.5, // increses player power for the match
      hnames: ['dev Warrior'],
    ...
    },
    {
      ...
      dtextures: ['hero01', 'hero01', 'hero01'],
      positions: [290, 365, 450],
      winFactor: 1.2, // Affects deamons damage on hero 0-1. 0 easy
