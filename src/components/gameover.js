...
export class GameOverScreen extends Phaser.GameObjects.Container {
    ...
    constructor(scene) {
        ...
        this.text1 = new Phaser.GameObjects.Text(scene, 0, 0, "", { color: '#FFCC00', align: 'center', fontSize: 24, wordWrap: { width: 240, useAdvancedWrap: true } });
        this.add(this.text1);
        this.text2 = new Phaser.GameObjects.Text(scene, 0, 30, "", { color: '#ffffff', align: 'left', fontSize: 14, wordWrap: { width: 240, useAdvancedWrap: true } });
        this.add(this.text2);
        this.text3 = new Phaser.GameObjects.Text(scene, 0, 60, "", { color: '#ffffff', align: 'left', fontSize: 14, wordWrap: { width: 240, useAdvancedWrap: true } });
        this.add(this.text3);
        ...
        this.add(this.text5);
        this.text7 = new Phaser.GameObjects.Text(scene, 0, 140, "", { color: '#d81e5b', align: 'left', fontSize: 14, wordWrap: { width: 280, useAdvancedWrap: true } });
        this.add(this.text7);
        ...
        this.exitButton = new Weapon(this.scene, 0, 175, 'bluebtn', 'exit', (text) => {
            this.hideEvent = null;
            this.visible = false;
        ...
        this.text6 = new Phaser.GameObjects.Text(scene, 0, 175, "", { color: '#ffffff', align: 'left', fontSize: 18, wordWrap: { width: 240, useAdvancedWrap: true } });
        this.add(this.text6);
