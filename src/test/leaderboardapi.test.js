import { MicroverseAPI } from '../components/leaderboardapi.js';


let setMessage = { result: "Leaderboard score created correctly." };
let emptySetError = { message: "You need to provide a valid user for the score" };
